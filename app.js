...
function sumAndMultiply(a,b,c){
  var addify = sum(a,sum(b,c)[0])[0];
  var multitude = multiply(a,multiply(b,c)[0])[0];
  var message1 = a + ' and ' + b + ' and ' + c + ' sum to ' + addify + '.';
  var message2 = 'The product of ' + a + ' and ' + b + ' and ' + c + ' is ' + multitude + '.';
  return [addify,multitude,message1,message2];
}
